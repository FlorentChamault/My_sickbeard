...
class WindowsUpdateManager(UpdateManager):
    ...
    def __init__(self):
        ...
        self.version_url = 'https://github.com/FlorentChamault/My_sickbeard/windows_binaries/updates.txt'
...
class GitUpdateManager(UpdateManager):
    ...
    def _check_github_for_update(self):
        ...
        # find newest commit
        for curCommit in gh.commits('FlorentChamault', 'My_sickbeard', self.branch):
    ...
    def set_newest_text(self):
        ...
        if self._newest_commit_hash:
            url = 'http://github.com/FlorentChamault/My_sickbeard/compare/'+self._cur_commit_hash+'...'+self._newest_commit_hash
        else:
            url = 'http://github.com/FlorentChamault/My_sickbeard/commits/'
    ...
    def update(self):
        ...
        """
        self._run_git('config remote.origin.url git://github.com/FlorentChamault/My_sickbeard.git')
        self._run_git('stash')
        output, err = self._run_git('pull git://github.com/FlorentChamault/My_sickbeard.git '+self.branch) #@UnusedVariable
...
class SourceUpdateManager(GitUpdateManager):
    ...
    def update(self):
        ...
        tar_download_url = 'https://github.com/FlorentChamault/My_sickbeard/tarball/'+version.SICKBEARD_VERSION
        sb_update_dir = os.path.join(sickbeard.PROG_DIR, 'sb-update')
